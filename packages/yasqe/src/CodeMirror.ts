...
//and applying babel.
import type {Editor as CmEditor,Doc as CmDoc,Token as CmToken, Position as CmPosition,EditorConfiguration as CmEditorConfiguration} from 'codemirror'
...
import type { TokenizerState } from "./index";
