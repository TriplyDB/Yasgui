...
(function(e){e.forEach(function(e){if(e.hasOwnProperty("remove")){return}Object.defineProperty(e,"remove",{t:true,u:true,i:true,value:function remove(){if(this.parentNode!==null)this.parentNode.removeChild(this)}})})})([Element.prototype,CharacterData.prototype,DocumentType.prototype]);